...
public class ModelStymphalianBird extends ModelDragonBase {
    ...
    public AdvancedModelRenderer Lowerbodytilt;
    ...
    public AdvancedModelRenderer uppernail;
    ...
    public ModelStymphalianBird() {
        ...
        this.WingL3 = new AdvancedModelRenderer(this, 96, 60);
        ...
        this.Jaw = new AdvancedModelRenderer(this, 14, 11);
        this.Jaw.setRotationPoint(0.0F, 0.0F, -2.6F);
        ...
        this.ToeR2 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeR2.mirror = true;
        this.ToeR2.setRotationPoint(0.0F, 10.8F, 0.2F);
        this.ToeR2.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(ToeR2, -1.593485607070823F, -0.6108652381980153F, 0.0F);
        this.Crest3 = new AdvancedModelRenderer(this, 68, 20);
        this.Crest3.setRotationPoint(0.0F, 0.4F, 0.2F);
        ...
        this.BackLegL2 = new AdvancedModelRenderer(this, 17, 42);
        this.BackLegL2.mirror = true;
        this.BackLegL2.setRotationPoint(0.0F, 4.4F, 0.2F);
        ...
        this.BackLegR1.setRotationPoint(-2.5F, 1.1F, 1.6F);
        ...
        this.BackLegL1.setRotationPoint(2.5F, 1.1F, 1.6F);
        ...
        this.HeadFront = new AdvancedModelRenderer(this, 0, 9);
        this.HeadFront.setRotationPoint(0.0F, -0.4F, -2.5F);
        ...
        this.ToeL1 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeL1.mirror = true;
        this.ToeL1.setRotationPoint(0.0F, 11.1F, 0.2F);
        this.ToeL1.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(ToeL1, -2.0032889154390916F, 3.141592653589793F, 0.0F);
        this.ToeR3 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeR3.mirror = true;
        this.ToeR3.setRotationPoint(0.0F, 10.8F, -0.7F);
        this.ToeR3.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(ToeR3, -1.5481070465189704F, 0.0F, 0.0F);
        this.TailL2 = new AdvancedModelRenderer(this, 52, 25);
        this.TailL2.setRotationPoint(0.0F, 0.1F, 7.0F);
        ...
        this.uppernail = new AdvancedModelRenderer(this, 11, 4);
        this.uppernail.setRotationPoint(0.0F, -0.8F, -4.8F);
        this.uppernail.addBox(-0.5F, -0.4F, -2.0F, 1, 1, 3, 0.0F);
        this.setRotateAngle(uppernail, 1.6845917940249266F, -0.0F, 0.0F);
        this.ToeR1 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeR1.mirror = true;
        this.ToeR1.setRotationPoint(0.0F, 11.1F, 0.2F);
        ...
        this.Crest2 = new AdvancedModelRenderer(this, 68, 20);
        this.Crest2.setRotationPoint(0.0F, 0.4F, 0.2F);
        this.Crest2.addBox(-0.5F, -1.21F, 0.39F, 1, 3, 8, 0.0F);
        this.setRotateAngle(Crest2, -0.31869712141416456F, 0.0F, 0.0F);

        this.LowerBody = new AdvancedModelRenderer(this, 23, 12);
        this.LowerBody.setRotationPoint(0.0F, 0.0F, 0.7F);
        ...
        this.WingL.setRotationPoint(3.0F, -1.6F, -1.2F);
        this.WingL.addBox(-0.1F, 0.0F, -5.0F, 1, 8, 12, 0.0F);
        this.setRotateAngle(WingL, 0.08726646259971647F, 0.0F, -0.17453292519943295F);
        this.BackLegR2 = new AdvancedModelRenderer(this, 17, 42);
        this.BackLegR2.setRotationPoint(0.0F, 4.4F, 0.2F);
        ...
        this.ToeL2 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeL2.mirror = true;
        this.ToeL2.setRotationPoint(0.0F, 10.8F, 0.2F);
        this.ToeL2.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(ToeL2, -1.593485607070823F, 0.6108652381980153F, 0.0F);
        this.TailL1 = new AdvancedModelRenderer(this, 54, 5);
        this.TailL1.setRotationPoint(0.0F, -0.2F, 6.1F);
        ...
        this.WingR3 = new AdvancedModelRenderer(this, 96, 60);
        ...
        this.Lowerbodytilt = new AdvancedModelRenderer(this, 0, 54);
        this.Lowerbodytilt.setRotationPoint(0.0F, 3.2F, -3.5F);
        this.Lowerbodytilt.addBox(-3.0F, 2.4F, -0.9F, 6, 8, 4, 0.0F);
        this.setRotateAngle(Lowerbodytilt, 1.730144887501979F, 0.0F, 0.0F);
        this.Body = new AdvancedModelRenderer(this, 34, 47);
        ...
        this.ToeL3 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeL3.mirror = true;
        this.ToeL3.setRotationPoint(0.0F, 10.8F, -0.7F);
        this.ToeL3.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(ToeL3, -1.593485607070823F, 0.0F, 0.0F);
        this.Crest1 = new AdvancedModelRenderer(this, 68, 20);
        this.Crest1.setRotationPoint(0.0F, -1.6F, -2.0F);
        ...
        this.TailR2 = new AdvancedModelRenderer(this, 52, 25);
        this.TailR2.mirror = true;
        this.TailR2.setRotationPoint(0.0F, 0.1F, 7.0F);
        ...
        this.ToeL4 = new AdvancedModelRenderer(this, 0, 43);
        this.ToeL4.mirror = true;
        this.ToeL4.setRotationPoint(0.0F, 10.8F, 0.2F);
